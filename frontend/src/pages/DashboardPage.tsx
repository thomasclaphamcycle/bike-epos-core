...
const WORKSHOP_WAITING_STATUSES = [
  "BOOKING_MADE",
  "READY_FOR_WORK",
  "PAUSED",
...
const WORKSHOP_IN_PROGRESS_STATUSES = ["IN_PROGRESS", "BIKE_ARRIVED", "APPROVED"];
const WORKSHOP_READY_STATUSES = ["READY_FOR_COLLECTION", "BIKE_READY", "READY"];
