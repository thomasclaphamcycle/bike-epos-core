      ...
      <header className="app-header">
        <div className="header-left">
          ...
          <nav className="nav-links">
            ...
            {canViewManagement ? <NavLink to="/management/communications" className={navClass}>Communications</NavLink> : null}
            ...
            {canViewManagement ? <NavLink to="/management/staff-performance" className={navClass}>Staff Throughput</NavLink> : null}
            ...
            {canViewManagement ? <NavLink to="/management/inventory" className={navClass}>Inventory Velocity</NavLink> : null}
            {canViewManagement ? <NavLink to="/management/suppliers" className={navClass}>Supplier Performance</NavLink> : null}
            ...
            {canViewManagement ? <NavLink to="/management/purchasing" className={navClass}>PO Action Centre</NavLink> : null}
            ...
            {canViewManagement ? <NavLink to="/management/docs" className={navClass}>Docs</NavLink> : null}
            ...
            {canViewStaffAdmin ? <NavLink to="/management/onboarding" className={navClass}>Onboarding</NavLink> : null}
