...
export const deliverProductLabelPrintRequestToAgent = async (
  ...
  if (!config.url) {
    throw new HttpError(
      503,
      "Product-label print agent is not configured. Set COREPOS_PRODUCT_LABEL_PRINT_AGENT_URL or COREPOS_SHIPPING_PRINT_AGENT_URL to enable direct Dymo printing.",
