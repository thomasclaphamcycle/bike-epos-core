...
const TITLE_FONT = "700 29px Arial";
const VARIANT_FONT = "600 16px Arial";
const PRICE_FONT = "bold 35px Arial";
const BARCODE_TEXT_FONT = "700 19px monospace";
const PRODUCT_NAME_MAX_LINES = 2;
const PRODUCT_LINE_HEIGHT = 27;
const LOGO_MAX_HEIGHT = 103;
const LOGO_MAX_WIDTH = 305;
const LOGO_FALLBACK_HEIGHT = 18;
const TITLE_SECTION_GAP = 20;
const VARIANT_SECTION_GAP = 4;
const PRICE_SECTION_GAP = 3;
const PRICE_LINE_HEIGHT = 30;
