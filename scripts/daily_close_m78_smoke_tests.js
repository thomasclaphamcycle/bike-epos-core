...
const run = async () => {
  ...
  try {
    ...
    const printResponse = await fetch(`${BASE_URL}/reports/daily-close/print?date=${today}`, {
      headers: managerHeaders,
    });
    ...
    const staffPrint = await fetch(`${BASE_URL}/reports/daily-close/print?date=${today}`, {
      headers: staffHeaders,
    });
