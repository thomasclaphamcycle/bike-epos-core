...
- `scripts/dev_stop_local.sh` stops the normal backend on `http://localhost:3000` and frontend on `http://localhost:5173` when they are clearly the local CorePOS dev servers.
