...
- the first event-driven workshop notification layer now sends quote-ready and ready-for-collection messages over email and SMS when customer contact details are available, while still logging skipped or duplicate-safe outcomes per channel
