...
- workshop now also has a staff-facing calendar scheduler at `/workshop/calendar`, with week view as the default, day view as a secondary toggle, timed booking blocks, quick schedule editing, rota-backed availability context, time off, and live unscheduled / unassigned queues
