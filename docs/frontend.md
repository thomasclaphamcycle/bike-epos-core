...
For the full phone/NFC customer-capture tunnel setup, use [docs/dev-tunnel-customer-capture.md](/Users/thomaswitherspoon/Development/bike-epos-core/docs/dev-tunnel-customer-capture.md), including `npm run dev:tunnel` and `npm run dev:tunnel:reset`.
